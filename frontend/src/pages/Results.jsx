...
export default function Results() {
  ...
  if (!result) {
    return (
      <main className="max-w-lg mx-auto my-16 px-6 py-10 bg-[#fae8d2]/90 border border-[#e0c2a5]/60 
      rounded-3xl shadow-lg text-center font-sans">
        ...
        <Link
          to="/test"
          className="inline-block bg-gradient-to-r from-[#2251e7] to-[#1f46c7] hover:from-[#1f46c7] 
          hover:to-[#193aab] text-white font-semibold py-3 px-8 rounded-full shadow-md hover:shadow-lg 
  ...
  return (
    <main className="max-w-lg mx-auto my-16 px-6 py-10 bg-[#fae8d2]/90 border border-[#e0c2a5]/60 
    rounded-3xl shadow-xl font-sans text-center">
      <h2 className="text-3xl sm:text-4xl font-bold text-[#0f172a] mb-6 drop-shadow-sm">
        Resultado del Test
      </h2>
      <div className="flex justify-center mb-8">
        <div
          className={`w-28 h-28 sm:w-32 sm:h-32 rounded-full shadow-md ${circleColor} transition-all 
          duration-500`}
        />
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 mt-6">
        <Link
          to="/test"
          className="bg-gradient-to-r from-[#2251e7] to-[#1f46c7] hover:from-[#1f46c7] 
          hover:to-[#193aab] text-white font-semibold py-3 px-6 sm:px-8 rounded-full shadow-md 
        ...
        <Link
          to="/"
          className="text-[#1f46c7] hover:text-[#193aab] font-medium text-base hover:underline 
          transition-all"
        >
          Volver al inicio
        </Link>
